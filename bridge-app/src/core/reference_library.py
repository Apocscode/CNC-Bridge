    ...
    entries.extend([
        ...
        ReferenceEntry(
            ...
            description="⚠ STANDARD RS232 CABLES WILL NOT WORK ⚠\n\n"
                        ...
                        "CONNECTOR GENDER:\n"
                        "• Controller port: DB-25 FEMALE (on the Anilam machine)\n"
                        "• Cable machine end: DB-25 MALE (plugs into controller)\n"
                        "• Cable PC end: DB-9 FEMALE (plugs into COM port or USB adapter)\n"
                        "  — or DB-25 FEMALE if your PC has a native DB-25 serial port\n\n"
                        "═══ DB-25 Male (Machine End) to DB-9 Female (PC End) ═══\n\n"
                        ...
                        "═══ DB-25 Male (Machine End) to DB-25 Female (PC End) ═══\n\n"
